...
namespace Consolebingapp
{
    class Translator
    {
        ...
        public static string translate(String outLanguage, string text, string inlanguage)
        {
            if (inlanguage == null)
                inlanguage = "";
            ...
            using (OperationContextScope scope = new OperationContextScope(client.InnerChannel))
            {
                ...
                translationResult = client.Translate("", text, inlanguage, outLanguage, "text/html", "general");
                //Console.WriteLine("result of ", text, inlanguage, outLanguage);

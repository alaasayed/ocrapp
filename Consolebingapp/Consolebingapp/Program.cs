...
namespace Consolebingapp.SoapSamples
{
    class Program
    {

        string translationResult;
        static string str1 = "سيارة";
        string fromlang = "ar";
        string tolang = "en";
        ...
        public void translation(string authToken)
        {
            ...
            using (OperationContextScope scope = new OperationContextScope(client.InnerChannel))
            {
                ...
                translationResult = client.Translate("", str1, fromlang, tolang, "text/html", "general");
                Console.WriteLine("result of ", str1, fromlang, tolang);
